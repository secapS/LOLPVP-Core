...
public class ItemProjectile extends EntityItem implements IProjectile, CustomProjectile {
    ...
    public ItemProjectile(String name, Location loc, org.bukkit.inventory.ItemStack itemstack, LivingEntity shooter, float power) {
        ...
        if (CraftItemStack.asNMSCopy(itemstack) != null) setItemStack(CraftItemStack.asNMSCopy(itemstack));
            ...
            setItemStack(new net.minecraft.server.v1_7_R4.ItemStack(Item.getById(itemstack.getTypeId()), itemstack.getAmount(), itemstack.getData().getData()));
    ...
    public void h() {
        ...
        if ((flag) || (this.ticksLived % 25 == 0)) {
            if (this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.locY), MathHelper.floor(this.locZ)) == net.minecraft.server.v1_7_R4.Block.b("lava")) {
    ...
    public net.minecraft.server.v1_7_R4.ItemStack getItemStack() {
        net.minecraft.server.v1_7_R4.ItemStack itemstack = getDataWatcher().getItemStack(10);

        if (itemstack == null) {
            return new net.minecraft.server.v1_7_R4.ItemStack(Blocks.STONE);
        }
        return itemstack;
    }
